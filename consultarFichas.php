...
$nav=24 ; // esta variable indica la pasteña a la que se le modifica el css en el nav
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          <thead>
            <tr>
              <?php $resultado = consultaColumnasth('ficha1');?>
            </tr>
          </thead>
          <tfoot>
            <tr>
...
<div class="modal fade bs-example-modal-lg" id="mVentana" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Aprendices de la Ficha</h4>
      </div>
...
$(document).ready(function() {
	...
	$('#example').dataTable( {
		"processing": true,
		"serverSide": true,
		"ajax": "modelo/server_processing.php?t=ficha1",
		 ...
		 if ( $(this).hasClass('selected') ) {
				...
				if(!isNaN(id)){
					...
					$.ajax({
						...
						type: "POST", 
						data: {proceso:"ficha",id:id}, 
						success: function(datos){
							$("#loadingAjax").fadeOut(300);
							$('.modal-title').text("Aprendices vinculados a la Ficha " + id)
